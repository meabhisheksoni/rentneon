...
import { User, MapPin, Calendar, IndianRupee } from 'lucide-react'
  ...
  return (
    <>
      <div
        ...
        className="bg-white rounded-2xl border border-gray-200 p-5 hover:shadow-lg transition-all duration-300 cursor-pointer hover:border-blue-200 group"
      >
